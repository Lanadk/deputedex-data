-- OK valide
create materialized view if not exists agg_groupes_stats_professions_familles as
...
create unique index if not exists agg_groupes_stats_professions_familles_uq on agg_groupes_stats_professions_familles (
                                                               groupe_id,
                                                               legislature,
                                                               profession_famille
    );